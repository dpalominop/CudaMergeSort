...
int main(int argc, char **argv)
{
	...
	if (argc != 3) {
		std::cout << "Uso: " << argv[0] << " array-size list-name\n" <<std::endl;
		return 1;
	}
    ...
    std::cout << "Initializing GPU merge sort..." << std::endl;
    initMergeSort();

    std::cout << "Running GPU merge sort..." << std::endl;
